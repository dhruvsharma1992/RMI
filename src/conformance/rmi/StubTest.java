...
public class StubTest extends Test {
	 ...
	 * 
	 * @throws TestFailed
	 *             If <code>IllegalStateException</code> is not thrown.
	 */
	private void ensureUnknownHostRejected() throws TestFailed {
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>) threw " + "an unexpected exception when given a "
	 ...
	 * 
	 * @throws TestFailed
	 *             If a <code>Stub</code> is created from a class, or if an
	 ...
	 * 
	 * @throws TestFailed
	 *             If a <code>Stub</code> is created from a non-remote
	...
	private void ensureNonRemoteInterfaceRejected() throws TestFailed {
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, InetSocketAddress) " + "has accepted a non-remote interface");
		} catch (TestFailed e) {
			throw e;
		} catch (Error e) {
		} catch (Throwable t) {
	 ...
	 * 
	 * @throws TestFailed
	 *             If <code>null</code> is given as a parameter but the correct
	...
	private void ensureNullPointerExceptions() throws TestFailed {
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>) " + "accepted null for first argument");
		} catch (TestFailed e) {
			throw e;
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>, String) " + "accepted null for first argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, InetSocketAddress) " + "accepted null for first argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>) " + "accepted null for second argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
		...
		try {
			TestInterface stub = Stub.create(TestInterface.class, (Skeleton<TestInterface>) null, "127.0.0.1");
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>, String) " + "accepted null for second argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, InetSocketAddress) " + "accepted null for second argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
		...
		try {
			...
			throw new TestFailed("Stub.create(Class<T>, Skeleton<T>, String) " + "accepted null for third argument");
		} catch (TestFailed e) {
			throw e;
		} catch (NullPointerException e) {
		} catch (Throwable t) {
	...
	/**
	 * Ensures that stubs for the same skeleton are equal and have the same hash
	 * code, and stubs have a string representation.
	 * 
	 * @throws TestFailed
	 *             If the test fails.
	 */
	private void ensureLocalMethods() throws TestFailed {
		...
		try {
			...
			throw new TestFailed("equals threw an unexpected exception when " + "comparing a stub to null", t);
		}
		...
		try {
			...
			throw new TestFailed("equals threw an unexpected exception when " + "comparing equal stubs", t);
		}
		...
		try {
			...
			throw new TestFailed("equals threw an unexpected exception when " + "comparing unequal stubs", t);
		}
